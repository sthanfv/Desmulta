                ...
                <div className="flex flex-col items-center">
                    <div className="bg-green-500/10 text-green-400 p-4 rounded-lg w-full mb-4 flex items-start gap-3 border border-green-500/20">
                        ...
                        <div>
                            ...
                            <a href={uploadedUrl} target="_blank" rel="noreferrer" className="text-xs break-all underline hover:text-green-300 mt-1 block">
                                {uploadedUrl}
                            </a>
                        </div>
                    </div>

                    <img src={uploadedUrl} alt="Uploaded preview" className="w-full max-h-64 object-contain rounded-lg border border-slate-700 mb-4" />
