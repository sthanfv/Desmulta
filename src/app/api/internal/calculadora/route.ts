...
interface ResultadoCalculadoraCompleta {
 ...
 */
function calcularViabilidadLegal(
...
import { FINANCIAL_HISTORY, getSMDLVHistorico } from '@/lib/financial-history';
 ...
 */
function calcularInteresesHistoricos(
 ...
 */
function calcularMultaCompleta(
...
export async function POST(req: NextRequest) {
  try {
    ...
    if (!valorMulta2026 || !fechaInfraccionISO) {
