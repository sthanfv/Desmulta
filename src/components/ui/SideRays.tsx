...
const SideRays = ({
  ...
  useEffect(() => {
    // Rendimiento móvil y accesibilidad: Evitar instanciar WebGL si no es necesario o en dispositivos gama baja
    if (!isVisible || !containerRef.current || reducedMotion || isLowTier) return;
