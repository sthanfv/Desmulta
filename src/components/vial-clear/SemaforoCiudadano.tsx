    ...
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <div className="flex-1 pt-1 relative z-10">
          ...
          {lowConfidence && (
            <div className="mt-3 inline-flex items-center gap-1.5 px-2.5 py-1 min-h-[20px] rounded-md bg-yellow-500/10 border border-yellow-500/20 text-[11px] font-bold text-yellow-500 uppercase tracking-widest animate-in fade-in slide-in-from-bottom-1 duration-700">
