...
export const cspHeader =
  ...
  img-src 'self' data: blob: https://desmulta.online https://*.public.blob.vercel-storage.com https://*.vercel-storage.com https://firebasestorage.googleapis.com https://images.unsplash.com https://vercel.com https://challenges.cloudflare.com https://c.clarity.ms https://*.clarity.ms;
