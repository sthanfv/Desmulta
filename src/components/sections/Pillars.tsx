...
export const Pillars = () => {
  return (
    <section id="servicios" className="py-16 md:py-24 px-4 relative">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          ...
          <TarjetaPremium className="reveal md:col-span-2 p-8 md:p-10 rounded-[2.5rem] backdrop-blur-sm border-border/50 hover:border-primary/50 transition-all duration-700 group flex flex-col justify-center">
          ...
          <TarjetaPremium className="reveal md:col-span-1 p-8 md:p-10 rounded-[2.5rem] backdrop-blur-sm border-border/50 hover:border-primary/50 transition-all duration-700 group flex flex-col justify-center">
