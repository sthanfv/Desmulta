...
export const cspHeader =
  ...
  img-src 'self' data: blob: https://desmulta.online https://*.public.blob.vercel-storage.com https://*.vercel-storage.com https://firebasestorage.googleapis.com https://images.unsplash.com https://vercel.com https://challenges.cloudflare.com;
  ...
  connect-src 'self'${devConnect} data: blob: https://*.googleapis.com https://*.firebaseio.com https://cdn.jsdelivr.net https://challenges.cloudflare.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://api.telegram.org https://va.vercel-scripts.com https://vercel.live https://*.vercel.live https://*.vercel-storage.com https://*.resend.com https://*.sentry.io https://*.ingest.sentry.io https://*.ingest.us.sentry.io https://www.google.com/recaptcha/ https://www.gstatic.com/recaptcha/ https://checkout.wompi.co;
