...
describe('🌍 Edge Middleware - Hiper Localismo', () => {
  it('Debe transferir la ciudad codificada desde Vercel a nuestra cabecera personalizada', async () => {
  ...
  it('Debe usar "Colombia" como fallback si la petición no trae la cabecera de Vercel', async () => {
