...
export async function POST() {
  logger.warn(
    '[simit-worker] Intento de acceso a ruta de scraper SIMIT desactivada permanentemente por Compliance.'
  );
  ...
  return NextResponse.json(
    {
      ...
      message:
        'Esta funcionalidad ha sido dada de baja permanentemente por cumplimiento normativo (Anti-Scraping).',
    },
    { status: 410 } // 410 Gone
  );
}
