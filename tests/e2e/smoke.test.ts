...
test.describe('Portal Ciudadano - Smoke Tests', () => {
  ...
  test('el formulario de consulta debe abrirse al hacer click', async ({ page }) => {
    ...
    // [2026-09-23] El CTA de la Hero es "Estudio Legal Gratuito"; "Iniciar estudio sin costo"
    // pasó a ser un título (h4) dentro de la calculadora, por eso el test nunca lo encontraba.
    const consultButton = page.locator('button', { hasText: /Estudio Legal Gratuito/i }).first();
