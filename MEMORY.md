...
- **Qué cambió:**
  ...
  - Se eliminó el fondo blanco puro y plano de la página `/plantillas` y del `Hero.tsx` (página de inicio), reemplazándolo por gradientes sutiles (ej. `from-slate-50 via-white to-amber-50/40`) y un patrón arquitectónico de puntos tenues para aportar textura, calidez y profundidad visual sin comprometer el minimalismo.
