...
export default async function Image({ params }: { params: { ciudad: string } }) {
  ...
  return new ImageResponse(
    (
      ...
      >
        <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: '10px', background: '#FFC107' }} />
        <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: '10px', background: '#FFC107' }} />
        ...
        >
          Fotomultas en{' '}
          <span style={{ color: '#FFC107' }}>{nombreCiudad}</span>
        </h1>
