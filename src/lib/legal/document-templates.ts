...
const APODERADO = 'FABIAN ANDRES VELENO MOYA, C.C. No. 1090458663';
...
const poderEspecial: DocumentBlock = {
  ...
  cuerpo: (d) => [
    ...
    `otorgo PODER ESPECIAL, amplio y suficiente a ${APODERADO},`,
...
const prescripcionDirecta: DocumentBlock = {
  ...
  cuerpo: (d) => [
    ...
    `actuando en mi propio nombre, otorgo PODER ESPECIAL a ${APODERADO},`,
    ...
    `registradas a mi nombre${placa(d)}.`,
    ``,
...
const doblePrescripcion: DocumentBlock = {
  ...
  cuerpo: (d) => [
    `Yo, ${d.infractorName}, identificado(a) con C.C. No. ${d.infractorId},`,
    `otorgo PODER ESPECIAL AMPLIO a ${APODERADO},`,
    `para que en mi nombre solicite la declaratoria de PRESCRIPCION EXTINTIVA`,
    `POR DOBLE TERMINO de la(s) multa(s) de transito${placa(d)}.`,
    ``,
...
const nulidadNotificacion: DocumentBlock = {
  ...
  cuerpo: (d) => [
    `Yo, ${d.infractorName}, identificado(a) con C.C. No. ${d.infractorId},`,
    `otorgo PODER ESPECIAL a ${APODERADO}, para que en`,
    `mi nombre interponga RECURSO DE NULIDAD E INVALIDEZ ante la Secretaria`,
    `de Transito competente respecto de la(s) foto-multa(s) registradas`,
    `a mi nombre${placa(d)}.`,
    ``,
...
const tutelaSilencio: DocumentBlock = {
  ...
  cuerpo: (d) => [
    `Yo, ${d.infractorName}, identificado(a) con C.C. No. ${d.infractorId},`,
    `otorgo PODER ESPECIAL a ${APODERADO}, para que`,
