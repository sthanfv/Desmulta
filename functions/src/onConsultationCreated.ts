              ...
              <div style="padding: 40px 30px;">
                ...
                <div style="margin: 40px 0; text-align: center; background: #f8fafc; padding: 25px; border-radius: 12px; border: 1px dashed #cbd5e1;">
                  ...
                  ${trackingUuid ? `<div style="margin-top: 20px;">
                    ${qrDataUri ? `<div style="text-align:center;margin:20px 0"><img src="${qrDataUri}" alt="QR Seguimiento" style="width:150px;height:150px;border-radius:8px;border:2px solid #e2e8f0;background:white;padding:5px;" /></div>` : ''}
