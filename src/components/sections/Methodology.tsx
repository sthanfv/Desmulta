              ...
              <div className="grid gap-6">
                {[
                  ...
                  },
                  {
                    ...
                    desc: 'Le comunicamos el resultado y le indicamos cómo verificar los cambios en los portales oficiales RUNT y SIMIT.',
              ...
              <div className="grid gap-6 pt-4">
                {[
                  ...
                  },
                  {
                    ...
                    descripcion:
                      'Somos un equipo certificado de gestores administrativos independientes. Honorarios acordados antes de iniciar. Sin costos ocultos ni sorpresas — el valor se define según la complejidad de su caso.',
                    icon: <FileText className="w-6 h-6" />,
                  },
                  {
