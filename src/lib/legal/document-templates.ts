...
function getPreamble(d: CaseDataForPDF, asunto: string): string[] {
  const ciudad = d.ciudadEmision || 'Ciudad';
  const autoridad = d.autoridadTransito || 'Oficina de Contravenciones / Tránsito';
  const date = new Date();
