            ...
            >
              ...
              <div className="flex flex-col h-full justify-between text-left font-mono text-zinc-800 dark:text-zinc-100">
                ...
                <div className="my-3 space-y-2 text-[8px] text-zinc-500/80 dark:text-zinc-400/80 leading-relaxed blur-[1.5px] opacity-25 select-none pointer-events-none">
                  ...
                  <p>
                    Solicito respetuosamente se sirva ordenar la actualización de las bases de datos
                    correspondientes al SIMIT y RUNT de las siguientes obligaciones
              ...
              <div className="flex flex-col h-full justify-between text-left font-mono text-zinc-800 dark:text-zinc-100">
                ...
                <div className="my-3 space-y-2 text-[8px] text-zinc-500/80 dark:text-zinc-400/80 leading-relaxed blur-[1.5px] opacity-25 select-none pointer-events-none">
                  ...
                  <p>
                    ...
                    Nacional de Tránsito), el cual establece un término de prescripción de tres (3)
                    años contados a partir del hecho...
                  </p>
                  <p>
                    Dado que la obligación contravencional data de una antigüedad superior a los 36
                    meses sin que se haya notificado mandamiento de pago dentro del término
              ...
              <div className="flex flex-col h-full justify-between text-left font-mono text-zinc-800 dark:text-zinc-100">
                ...
                <div className="my-3 space-y-2 text-[8px] text-zinc-500/80 dark:text-zinc-400/80 leading-relaxed blur-[1.5px] opacity-25 select-none pointer-events-none">
                  <p>
                    En mi calidad de ejecutado dentro del proceso administrativo de cobro coactivo,
                    comparezco para interponer la excepción de prescripción de la obligación
                    conforme al Estatuto Tributario...
                  </p>
                  <p>
                    La Corte Constitucional en Sentencia T-645 de 2017 ha determinado la aplicación
                    del doble término de prescripción (3 años para proferir mandamiento y 3 años
              ...
              <div className="flex flex-col h-full justify-between text-left font-mono text-zinc-800 dark:text-zinc-100">
                ...
                <div className="my-3 space-y-2 text-[8px] text-zinc-500/80 dark:text-zinc-400/80 leading-relaxed blur-[1.5px] opacity-25 select-none pointer-events-none">
                  ...
                  <p>
                    La entidad accionada ha omitido dar respuesta de fondo, oportuna y congruente al
                    Derecho de Petición radicado en fecha anterior, configurándose la figura del
                    silencio administrativo...
                  </p>
                  <p>
                    Solicito se ordene a la accionada resolver la solicitud de prescripción de forma
                    inmediata y actualizar las bases de datos de cobro coactivo que impiden el libre
