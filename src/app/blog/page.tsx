...
export const metadata = {
  ...
  description:
    'Artículos legales y guías sobre cómo defenderte de fotomultas injustas en Colombia.',
};
      ...
      <div className="max-w-4xl mx-auto space-y-12">
        <div className="space-y-4 text-center">
          ...
          <p className="text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto">
            Conoce tus derechos como conductor en Colombia y aprende a defenderte de cobros
            injustos.
          </p>
        </div>
