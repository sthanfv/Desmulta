...
- **Exportar Datos**: Permite exportar la base de expedientes. Puedes aplicar filtros avanzados (por ciudad, estado, fecha de inicio y fecha de fin) para descargar exactamente lo que necesitas. *Nota de Seguridad*: Toda acción de exportación queda registrada inmutablemente en el log de auditoría de Firestore.
