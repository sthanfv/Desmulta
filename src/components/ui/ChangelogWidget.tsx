  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 py-1.5 rounded-md text-[11px] font-medium tracking-wide text-foreground/80 hover:text-foreground hover:bg-foreground/5 dark:text-zinc-400 dark:hover:text-zinc-100 dark:hover:bg-zinc-800/50 border border-transparent hover:border-foreground/10 dark:hover:border-zinc-700/50 transition-all duration-300"
