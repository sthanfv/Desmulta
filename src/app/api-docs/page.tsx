...
export const metadata: Metadata = {
  ...
  description:
    'Integra nuestro potente motor OCR y calculadora legal en tu propio software. API RESTful de grado empresarial para firmas de abogados, fintechs y flotas.',
};
      ...
      <main className="pt-32 pb-24 px-6 max-w-5xl mx-auto space-y-24">
        ...
        <section className="text-center space-y-8 relative">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Accede al mismo motor OCR avanzado y calculador determinista que procesa expedientes en
            Desmulta, directo en tu sistema vía REST.
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-8 rounded-3xl bg-card border border-border/50 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Autenticación mediante API Keys HMAC SHA-256. Prevención contra timing attacks y
              protección Zero-PII incorporada.
            </p>
          </div>
          <div className="p-8 rounded-3xl bg-card border border-border/50 space-y-4">
            <div className="w-12 h-12 rounded-2xl bg-primary/10 flex items-center justify-center text-primary">
            ...
            <p className="text-sm text-muted-foreground">
              Recibe directamente el dictamen legal procesado (prescrito, caducado, impugnable) con
              los valores en Salarios Mínimos (SMLMV).
            </p>
          </div>
          <div className="p-8 rounded-3xl bg-card border border-border/50 space-y-4">
            <div className="w-12 h-12 rounded-2xl bg-primary/10 flex items-center justify-center text-primary">
            ...
            <p className="text-sm text-muted-foreground">
              Respaldados por Vercel Edge y Redis, nuestra API escala automáticamente garantizando
        ...
        <section className="space-y-8">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Todas las solicitudes a la API deben incluir el header de autenticación con tu API Key
              provista por un administrador comercial de Desmulta.
            </p>
          </div>
        ...
        <section className="space-y-12">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl font-bold tracking-tight">
              1. Analizar Comparendo (OCR + Legal)
            </h2>
            <p className="text-muted-foreground">
              Endpoint unificado que recibe la imagen, ejecuta OCR estructurado con IA y evalúa el
              dictamen jurídico de caducidad y prescripción.
            </p>

            <div className="flex items-center gap-4">
              <span className="px-3 py-1 rounded bg-green-500/20 text-green-500 font-bold text-sm">
                POST
              </span>
    ...
    "analisisLegal": {
      ...
      "mensaje": "La infracción supera los 3 años de prescripción (Ley 769/2002)."
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              Si ya dispones de los datos extraídos (ej. desde el SIMIT), envíalos para obtener el
              análisis legal y cálculo financiero en SMLMV.
            </p>
      ...
      "mensaje": "La deuda es exigible pero los intereses superan el tope legal."
        ...
        <section className="p-12 rounded-[2.5rem] bg-gradient-to-br from-primary/20 via-background to-background border border-primary/20 text-center space-y-6">
          ...
          <p className="text-muted-foreground max-w-lg mx-auto">
            Nuestros planes B2B comienzan desde 500 consultas al mes. Contáctanos para emitir tu API
            Key comercial.
          </p>
          <div className="flex justify-center gap-4 pt-4">
            <Button
              ...
              asChild
            >
              <a href="https://wa.me/573005648309" target="_blank" rel="noopener noreferrer">
                Contactar a Ventas
              </a>
            </Button>
          </div>
