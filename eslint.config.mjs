...
const eslintConfig = [
  ...
  // Plugin de seguridad OWASP (auditoría de código)
  {
    ...
    rules: {
      ...
      // Prevenir comentarios TODO:/FIXME: en ramas de despliegue (Hallazgo 4 — Auditoría Manus AI)
      // Se usa location:'start' + términos con ':' para evitar falsos positivos con "todo" en español
