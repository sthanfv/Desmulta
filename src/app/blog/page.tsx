...
export const metadata: Metadata = {
  title: 'Blog y Guía Legal | Desmulta',
  description: 'Información técnica y jurídica actualizada para su defensa vial en Colombia.',
};
        ...
        dangerouslySetInnerHTML={{
          __html: safeJsonLdStringify({
            ...
            itemListElement: posts.map((post, index) => ({
              '@type': 'ListItem',
              position: index + 1,
              url: `https://desmulta.online/blog/${post.slug}`,
              name: post.title,
            })),
          }),
        }}
