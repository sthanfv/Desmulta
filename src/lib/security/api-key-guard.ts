...
/**
 * Busca el documento de API Key en Firestore usando el keyId.
 * El keyId son los primeros 16 caracteres de la key completa:
 * "dm_live_" (8 chars) + los primeros 8 chars del bloque aleatorio.
 * Ej: "dm_live_abc123xyz789abcdef" → keyId = "dm_live_abc123xy" (16 chars)
 * Este valor es el ID del documento en Firestore. La key completa nunca se almacena.
 */
