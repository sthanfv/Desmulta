...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      'fixed top-0 left-1/2 -translate-x-1/2 sm:left-auto sm:translate-x-0 z-[99999] flex max-h-screen w-full max-w-[90%] sm:max-w-[420px] flex-col-reverse p-4 pt-[calc(1rem+env(safe-area-inset-top))] sm:pt-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col',
      className
    )}
    {...props}
  />
