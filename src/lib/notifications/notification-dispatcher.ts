...
// Helper para dar formato consistente y premium al cuerpo del mensaje push
...
> = {
  ...
  archivo: (id, note) => ({
    ...
    body: formatBody(id, 'Tu expediente ha sido trasladado al archivo general histórico.', note),
  }),
};
